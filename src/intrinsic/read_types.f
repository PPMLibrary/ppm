            ...
            SUBROUTINE READ_complex1d_pointer(cpfile_id, ptr_addr, ptr)
               ...
               INTEGER(HID_T), INTENT(IN) :: cpfile_id
               CHARACTER(LEN=32) :: ptr_addr
               COMPLEX(8), DIMENSION(:), POINTER :: ptr
               INTEGER(HSIZE_T), DIMENSION(1) :: dims
            ...
            END SUBROUTINE read_complex1d_pointer
            SUBROUTINE READ_complex2d_pointer(cpfile_id, ptr_addr, ptr)
               IMPLICIT NONE
               INTEGER(HID_T), INTENT(IN) :: cpfile_id
               CHARACTER(LEN=32) :: ptr_addr
               COMPLEX(8), DIMENSION(:,:), POINTER :: ptr
            ...
            END SUBROUTINE read_complex2d_pointer
