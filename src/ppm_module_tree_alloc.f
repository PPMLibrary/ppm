...
#define __DECOMP           4
      ...
      !!! that allocate tree data structures.
         ...
         INTERFACE ppm_tree_alloc
            ...
            !<<<< haeckic begin >>>>!
            MODULE PROCEDURE ppm_tree_alloc_inhom_ts
            MODULE PROCEDURE ppm_tree_alloc_inhom_td
            MODULE PROCEDURE ppm_tree_alloc_inhom_ds
            MODULE PROCEDURE ppm_tree_alloc_inhom_dd
            !<<<< haeckic end >>>>!
         END INTERFACE
...
!<<<< haeckic begin >>>>!
#include "tree/ppm_tree_alloc_inhom.f"
!<<<< haeckic end >>>>!
#undef __KIND
