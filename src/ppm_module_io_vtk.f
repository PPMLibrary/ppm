...
#define __SCA              6
      ...
      MODULE ppm_module_io_vtk
         ...
         USE ppm_module_particles_typedef, ONLY: ppm_t_particles_s,&
                     ppm_t_particles_d,ppm_t_part_prop_s, ppm_t_part_prop_d,&
                     ppm_ppt_partial,ppm_param_default_nlID
  ...
  INCLUDE 'mpif.h'
         ...
         !----------------------------------------------------------------------
          INTERFACE ppm_vtk_particle_cloud
             MODULE PROCEDURE ppm_vtk_particle_cloud_s
             MODULE PROCEDURE ppm_vtk_particle_cloud_d
          END INTERFACE
...
#include "vtk/ppm_vtk_particle_cloud.f"
