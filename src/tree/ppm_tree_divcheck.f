...
!          ENDIF
         ...
         &                      .OR. result_array(j,k,1)+lmyeps .LT. min_box(j,i)+minboxsize(j))
                        temp_r = k-1
         ...
         &                      .NOT. (result_array(j,k,1)-lmyeps .LT. min_box(j,i)+minboxsize(j))) THEN
                  ...
                  IF (result_array(j,k,2)-lmyeps .GT. max_box(j,i)-minboxsize(j)) THEN
                     is_possible(j) = .FALSE.
!                         IF (ppm_rank .EQ. 0)THEN
!                             print *, ' CASE IN divcheck ' , i, k, result_array(j,1,1), result_array(j,1,2),&
!          &                              result_array(j,2,1)+lmyeps
!                          ENDIF
                  ENDIF
               ENDIF
