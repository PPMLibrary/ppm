...
#if   __MODE == __INL
      SUBROUTINE inl_xset_k_vlist_s(topoid,red,nred,mred, &
 &                   blue,nblue,mblue,rcblue,knn,    &
 &                   ghostlayer,info,vlist,nvlist,lstore)
#elif __MODE == __HNL
      SUBROUTINE hnl_xset_k_vlist_s(topoid,red,nred,mred, &
 &                   blue,nblue,mblue,cutoff,knn,    &
 &                   ghostlayer,info,vlist,nvlist,lstore)
#endif
#elif __KIND == __DOUBLE_PRECISION
#if   __MODE == __INL
      SUBROUTINE inl_xset_k_vlist_d(topoid,red,nred,mred,&
 &                   blue,nblue,mblue,rcblue,knn,    &
 &                   ghostlayer,info,vlist,nvlist,lstore)
#elif __MODE == __HNL
      SUBROUTINE hnl_xset_k_vlist_d(topoid,red,nred,mred,&
 &                   blue,nblue,mblue,cutoff,knn,    &
 &                   ghostlayer,info,vlist,nvlist,lstore)
#endif
#endif
      ...
      !!! Number of neighbours needed (k-nearest neighbours)
 ...
 &                 blue_sub,nblue_sub,mblue_sub,rcblue_sub,knn,&
...
#if   __KIND == __SINGLE_PRECISION
#if   __MODE == __INL
      END SUBROUTINE inl_xset_k_vlist_s
#elif __MODE == __HNL
      END SUBROUTINE hnl_xset_k_vlist_s
#endif
#elif __KIND == __DOUBLE_PRECISION
#if   __MODE == __INL
      END SUBROUTINE inl_xset_k_vlist_d
#elif __MODE == __HNL
      END SUBROUTINE hnl_xset_k_vlist_d
#endif
#endif
 ...
 &                        mblue,rcblue,knn,curr_dom,ghostlayer,info,&
 &                        vlist, nvlist, lstore)
#elif __KIND == __DOUBLE_PRECISION
