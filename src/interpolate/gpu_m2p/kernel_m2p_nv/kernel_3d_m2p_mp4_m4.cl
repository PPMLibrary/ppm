...
// m_id_x = -1
				...
				particle_mass[1] += wx*local_mesh[(BLOCK_SIZE_X+3)*(BLOCK_SIZE_Y+3)*(BLOCK_SIZE_Z+3) + l_ID];
				particle_mass[2] += wx*local_mesh[2*(BLOCK_SIZE_X+3)*(BLOCK_SIZE_Y+3)*(BLOCK_SIZE_Z+3) + l_ID];
				particle_mass[3] += wx*local_mesh[3*(BLOCK_SIZE_X+3)*(BLOCK_SIZE_Y+3)*(BLOCK_SIZE_Z+3) + l_ID];
