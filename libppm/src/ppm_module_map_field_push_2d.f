      !-------------------------------------------------------------------------
      !  Module       :            ppm_module_map_field_push_2d
      !-------------------------------------------------------------------------
      !
      ...
      !  Revisions    :
      !-------------------------------------------------------------------------
      !  $Log: ppm_module_map_field_push_2d.f,v $
      ...
      !
      !  Revision 1.1  2004/07/26 07:29:47  ivos
...
#define __VFIELD                   10
      ...
      MODULE ppm_module_map_field_push_2d
         ...
         !----------------------------------------------------------------------
         !  Define interface to ppm_map_field_push_2d
         !----------------------------------------------------------------------
         INTERFACE ppm_map_field_push_2d
...
#include "ppm_map_field_push_2d.f"
#undef __KIND
...
#undef __DIM
      ...
      END MODULE ppm_module_map_field_push_2d
