      ...
      !  Revisions    :
      !-------------------------------------------------------------------------
      !  $Log: ppm_map_field_push_3d.f,v $
      !  Revision 1.1.1.1  2007/07/13 10:18:56  ivos
      !  CBL version of the PPM library
      !
      !  Revision 1.19  2005/05/24 23:27:44  ivos
      ...
      !
      !  Revision 1.16  2004/11/11 15:23:03  ivos
      ...
      !  at link stage.
      !
      !  Revision 1.12  2004/07/26 07:42:43  ivos
      ...
      !
      !  Revision 1.9  2004/04/14 15:08:52  ivos
      ...
      !
      !  Revision 1.7  2004/04/05 10:45:30  ivos
      ...
      SUBROUTINE ppm_map_field_push_3d_sca_s(fdata,lda,frommesh,info,mask)
#elif  __KIND == __DOUBLE_PRECISION
      SUBROUTINE ppm_map_field_push_3d_sca_d(fdata,lda,frommesh,info,mask)
#elif  __KIND == __SINGLE_PRECISION_COMPLEX
      SUBROUTINE ppm_map_field_push_3d_sca_sc(fdata,lda,frommesh,info,mask)
#elif  __KIND == __DOUBLE_PRECISION_COMPLEX
      SUBROUTINE ppm_map_field_push_3d_sca_dc(fdata,lda,frommesh,info,mask)
#elif  __KIND == __INTEGER
      SUBROUTINE ppm_map_field_push_3d_sca_i(fdata,lda,frommesh,info,mask)
#elif  __KIND == __LOGICAL
      SUBROUTINE ppm_map_field_push_3d_sca_l(fdata,lda,frommesh,info,mask)
#endif 

#elif  __DIM == __VFIELD
#if    __KIND == __SINGLE_PRECISION
      SUBROUTINE ppm_map_field_push_3d_vec_s(fdata,lda,frommesh,info,mask)
#elif  __KIND == __DOUBLE_PRECISION
      SUBROUTINE ppm_map_field_push_3d_vec_d(fdata,lda,frommesh,info,mask)
#elif  __KIND == __SINGLE_PRECISION_COMPLEX
      SUBROUTINE ppm_map_field_push_3d_vec_sc(fdata,lda,frommesh,info,mask)
#elif  __KIND == __DOUBLE_PRECISION_COMPLEX
      SUBROUTINE ppm_map_field_push_3d_vec_dc(fdata,lda,frommesh,info,mask)
#elif  __KIND == __INTEGER
      SUBROUTINE ppm_map_field_push_3d_vec_i(fdata,lda,frommesh,info,mask)
#elif  __KIND == __LOGICAL
      SUBROUTINE ppm_map_field_push_3d_vec_l(fdata,lda,frommesh,info,mask)
#endif 
#endif 
      !-------------------------------------------------------------------------
      !  Includes
...
#include "ppm_define.h"
      ...
      INTEGER               :: iopt,Ndata,xlo,xhi,ylo,yhi,zlo,zhi,fromtopo
      REAL(MK)              :: t0
      LOGICAL               :: ldo
     ...
     &            'source meshid out of range',__LINE__,info)
          ...
          DO i=1,ppm_nsublist(fromtopo)
              ...
              ENDIF
              IF (ppm_cart_mesh(frommesh,fromtopo)%nnodes(3,isub).GT.zhi) THEN
                  zhi = ppm_cart_mesh(frommesh,fromtopo)%nnodes(3,isub)
              ENDIF
          ENDDO
#if   __DIM == __VFIELD
          IF (lda .LT. 1) THEN
     ...
     &            'lda must be >=1 for vector data',__LINE__,info)
              GOTO 9999
          ENDIF
          IF (SIZE(fdata,5) .LT. ppm_nsublist(fromtopo)) THEN
              info = ppm_error_error
              CALL ppm_error(ppm_err_argument,'ppm_map_field_push_3d',  &
     ...
     &                'z dimension of mask does not match mesh',__LINE__,info)
                  GOTO 9999
              ENDIF
              IF (SIZE(mask,4) .LT. ppm_nsublist(fromtopo)) THEN
                  info = ppm_error_error
                  CALL ppm_error(ppm_err_argument,'ppm_map_field_push_3d',  &
     ...
     &           'global send buffer PPM_SENDBUFFERD',__LINE__,info)
         ...
         DO i=1,ppm_nsendlist
            ...
            DO j=ppm_psendbuffer(i),ppm_psendbuffer(i+1)-1
               ...
               mofs(3) = ppm_cart_mesh(frommesh,fromtopo)%istart(3,jsub)-1
               !----------------------------------------------------------------
