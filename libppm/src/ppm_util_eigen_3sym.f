      ...
      !                 Eigenvectors of a symmetrix, REAL 3x3
      !                 matrix.
      !
      ...
      !  Input/output :                                            
      !
      !  Output       : Eval(3)      (F) Eigenvalues. Sorted with the
      !                                  largest value first.
      !                 Evec(3,3)    (F) Eigenvectors. Evec(:,1) is the
      !                                  first vector (to Eval(1)),
      !                                  Evec(:,2) the second and Evec(:,3)
      !                                  the third. Eigenvectors
      ...
      !  Revisions    :
      !-------------------------------------------------------------------------
      !  $Log: ppm_util_eigen_3sym.f,v $
      !  Revision 1.1.1.1  2007/07/13 10:19:01  ivos
      !  CBL version of the PPM library
      !
      !  Revision 1.10  2006/09/04 18:34:58  pchatela
      !  Fixes and cleanups to make it compile for
      !  release-1-0
      !
      !  Revision 1.9  2005/11/28 09:23:18  ivos
      !  Improved numerics according to Neil of CSCS.
      !
      !  Revision 1.8  2005/08/12 08:26:50  ivos
      !  If no eigenvector is found, 0 is returned rather than an error
      !  triggered. increases stability of tree decomps.
      !
      !  Revision 1.7  2004/12/03 17:18:12  ivos
      !  Fixed typo in debug message.
      !
      !  Revision 1.6  2004/11/04 14:49:15  ivos
      ...
      !  itself.
      !
      !  Revision 1.3  2004/09/17 15:10:11  ivos
      !  bugfix: Check for double Eval is no longer done for the last Eval,
      !  since the last one cannot be double. Routine tested for single
      !  and double Eigenvalues.
      !
      !  Revision 1.2  2004/09/17 14:09:03  ivos
      !  Added result checks at the end if ppm_debug.GT.1.
      !
      !  Revision 1.1  2004/09/17 11:58:49  ivos
