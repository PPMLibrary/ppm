      !-------------------------------------------------------------------------
      !  Module       :            ppm_module_map_field_pop_3d
      !-------------------------------------------------------------------------
      !
      ...
      !  Revisions    :
      !-------------------------------------------------------------------------
      !  $Log: ppm_module_map_field_pop_3d.f,v $
...
#define __VFIELD                   10
      ...
      MODULE ppm_module_map_field_pop_3d
         ...
         !----------------------------------------------------------------------
         !  Define interface to ppm_map_field_pop_3d
         !----------------------------------------------------------------------
         INTERFACE ppm_map_field_pop_3d
...
#include "ppm_map_field_pop_3d.f"
#undef __KIND
...
#undef __DIM
      ...
      END MODULE ppm_module_map_field_pop_3d
