...
minsub(1,2)=0.5_mk; minsub(2,2)=0._mk
maxsub(1,2)=1.0_mk; maxsub(2,2)=0.5_mk

minsub(1,3)=0._mk; minsub(2,3)=0.5_mk
maxsub(1,3)=0.5_mk; maxsub(2,3)=1.0_mk

minsub(1:ndim,4)=0.5_mk; maxsub(1:ndim,4)=1._mk
...
do ii=1,5
    ...
    call ppm_dbg_print(topoid,xp,mp,0.0_mk,1,2,info)
